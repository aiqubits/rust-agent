...
- a closed, bounded and domain-separated `generator-inputs.json` commits the exact normalized
  catalog plus package-owned root build requirements; manifest loading and full verification rerun
